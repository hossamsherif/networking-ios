#
# Be sure to run `pod lib lint NetworkLayerSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.2.0'
  s.summary          = 'NetworkLayerSwift is managed network layer built up on Moya network library.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'NetworkLayerSwift/Classes/**/*'
